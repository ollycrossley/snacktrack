...
export default function SimpleMap({ userLat, userLong }) {
  ...
  const iconsList = {
    ...
    "Other Soft Drinks":
      "https://i.ibb.co/ftfPB3n/other-drink-snacktrack-icon.png",
          ...
          if (business.is_active === true) {
            return (
              <MarkerF
                ...
                icon={{
                  url:
                    iconsList[business.category] ||
                    "https://i.ibb.co/cQPqCjF/custom-snacktrack-icon.png",
